...
#define SAVE_FLAG_PLEXUS_SHIFT_CORRIDOR  /* 0x00200000 */ (1 << 21)
#define SAVE_FLAG_PLEXUS_SHIFT_PAINTING_FRAME /* 0x00400000 */ (1 << 22)
#define SAVE_FLAG_PLEXUS_SHIFT_CASTLE_PROP /* 0x00800000 */ (1 << 23)
...
#define SAVE_FLAG_PLEXUS_NETWORK_OPEN    /* 0x20000000 */ (1 << 29)

#define SAVE_FLAG_PLEXUS_WORLD_SHIFT_MASK (SAVE_FLAG_PLEXUS_SHIFT_CORRIDOR | SAVE_FLAG_PLEXUS_SHIFT_PAINTING_FRAME | SAVE_FLAG_PLEXUS_SHIFT_CASTLE_PROP)
